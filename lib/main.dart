...
import 'rtmp_service.dart';

void main() => runApp(const MaterialApp(home: StreamApp()));
...
class StreamApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Native RTMP Stream")),
      body: Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            ElevatedButton(
              onPressed: () => RtmpService.start(
                "rtmp://sample.survey96.com/live",
                "12a908f5-9305-42ca-9c40-d4029e4d344e",
              ),
              child: const Text("Start Live"),
            ),
            const SizedBox(height: 20),
            ElevatedButton(
              onPressed: () => RtmpService.stop(),
...
//     text: "rtmp://192.168.1.15/live/live",
//   );
...
//     return "rtmp://sample.survey96.com/live/12a908f5-9305-42ca-9c40-d4029e4d344e";
//     // // Open up a dialog for the url
